...
import { Filter, Route, Star, MapPin, Candy, Edit2, Trash2, Plus } from 'lucide-react'
...
export default function Sidebar({
  ...
  const [filterType, setFilterType] = useState<'all' | 'top-rated' | 'my-houses'>('all')
  ...
  useEffect(() => {
    ...
    const handleStorageChange = () => loadHouses()
